...
private _str = [
	'<font face="RobotoCondensedBold" color="#fea80a">',
	'Players: </font>',
	...
	// each group member
	{
		if (isPlayer _x) then {
			...
			_text = [
				...
				'<font color="#fea80a" face="RobotoCondensed">',_unitIdentity select 2, '</font>',
				'<font color="#999999" face="RobotoCondensed">', _unitIdentity select 3,'</font>',
				'<br/>'
			] joinString "";
			_arr pushBack _text;
		};
